...
define config.name = _("Doki Doki Gensou PARADISE -Onegai Love Desu-")
...
define build.name = "DokiDokiGensouPARADISE-OnegaiLoveDesu-"
...
define config.save_directory = "MydearGensou-1582219408"
