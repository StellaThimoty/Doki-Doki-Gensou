...
screen extras_navigation():
    ...
    vbox:
        ...
        textbutton _("Galeria de Sprites") action ShowMenu("sprite_gallery")

        textbutton _("Galeria de Backgrounds") action ShowMenu("bg_gallery")

        textbutton _("Sala de Músicas") action ShowMenu("music_gallery")

        textbutton _("Sala de Replays") action ShowMenu("replay_gallery")
...
screen sprite_gallery():
    ...
    use extras_menu("Galeria de Sprites"):
...
screen credits():
    ...
    frame at credits_scroll(10.0):
        ...
        vbox:
            ...
            text "Feito com Ren'Py [renpy.version_only]." size 100

            null height 450

            text "Obrigado por Jogar!" size 100
...
screen results():
    ...
    vbox:
        ...
        text "Você leu: [readtotal]% do jogo" color "#fff"
